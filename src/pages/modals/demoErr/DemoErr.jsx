import style from "./DemoErr.module.scss";
import { createPortal } from "react-dom";
import "./DemoErr.css";

const DemoErr = ({ toggleModal, setToggleModal }) => {
  return (
    <>
      {toggleModal &&
        createPortal(
          <>
            ...
            <div className={style.block}>
              ...
              <p className={style.text}>
                Приложение находится в демо версии. Попробуйте позже...
              </p>
            </div>
          </>,
          document.body
